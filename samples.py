...
EnglishBase = """
this is an example of speech synthesis in english please do not fail yes no
spider man does whatever a can anywhere anytime germany austria language hello
I he she we our his my your there here never always forever ever window see
"""
EnglishLevel1 = """
question so proletariat choice decision girlfriend barbeque acquaintance stifled
innovative replicate incinerate obliterate obfuscate disposal available check
balance calendar display alarm digital electronics physics
"""
English1 = """
Spiderman, Spiderman, 
...
And although his airbending skills are great, he has a lot
to learn before he's ready to save anyone.
...
DragonBase = """
Dov wahlaan fah rel sahrot hunne Zin krif horvut se suleyk
Ok mulaag unslaad zeymah Dahmaan Drem Yol Lok fus ro dah
raan mir tah laas yah nir mid vur shaan feim zii gron gol hah
dov od ah viing hun kaal zoor lok vah koor ven gaar nos zun
haal viik fas ru maar mul qah diiv joor zah frul gaan lah haas
"""
Dragon1 = """
Dovahkiin, Dovahkiin
